...
implements: AI-C-05, AI-C-11, AI-C-13, AI-C-15, AI-C-16, AI-B-06
...
class ZoneApplication:
    ...
    def __init__(
        ...
        *,
        ...
        # A closed-network deployment filters out providers that declared
        # outbound reach before they are ever placed (AI-C-16). The gate is
        # built from the profile's own data, so upper-layer code needs no
        # domain branch and no knowledge of what is external.
        self._egress_gate = EgressGate.from_profile(profile)
        self._selector = CapabilitySelector(
            registry,
            placement_filter=placement_filter or self._egress_gate.rejection_reason,
        )
