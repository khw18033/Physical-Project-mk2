...
from perception_framework.execution.control import LocalControlSupervisor
from perception_framework.providers.fakes import (
    InMemoryObservabilityProvider,
    InMemoryTransportProvider,
    SyntheticMediaSourceProvider,
)
from perception_framework.providers.overlay import OverlayAwareRemoteGate, StaticOverlayProvider
from perception_framework.registry.capability_registry import CapabilityRegistry, ProviderRegistration
from perception_framework.runtime.airgap import AirgapPolicy, AssetRef, AssetResolver, ExternalDependency
from perception_framework.runtime.application import CapabilitySpec, ZoneApplication
from perception_framework.runtime.clusters import ClusterBinding, MultiClusterControlProvider, PlacementRequest
from perception_framework.runtime.reconfiguration import ResourceAdaptiveReconfigurer, ResourceSnapshot
from perception_framework.simulation.backend import BackendAvailabilityIntegrator
...
SPECS = [
    ...
    CapabilitySpec("perception.environment_map", degrade_rank=3),
    CapabilitySpec("ondevice.link_transition", degrade_rank=4),
...
register(registry, "perception.environment_map", "mapper", compute=3.0)
register(registry, "ondevice.link_transition", "link-monitor", compute=2.0)
...
from perception_framework.risk.fsm import RiskAnalysisFsm, RiskEvent  # noqa: E402
...
resolver = AssetResolver(
    base_locations={
        ...
        "generic": "/var/lib/perception-framework/assets",
    },
...
indicators = Path(__file__).resolve().parents[1] / "reports" / "framework-indicators.json"
