"""implements: AI-C-06, AI-C-14, AI-B-10, AI-O-03
...
def test_bridge_module_never_names_a_concrete_protocol_in_code():
    ...
    path = Path(__file__).resolve().parents[1] / "perception_framework" / "edge" / "bridge.py"
...
def test_media_payload_is_refused_on_the_backbone_transport():
    from perception_framework.common.data_plane import DataPlaneViolation
