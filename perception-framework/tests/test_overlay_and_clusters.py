"""implements: AI-C-17, AI-B-11, AI-O-04, AI-C-12
...
from perception_framework.providers.adapters import ControlProvider, NetworkOverlayProvider
from perception_framework.providers.overlay import (
