"""implements: HW-R-10, AI-B-05, AI-B-07, AI-B-08"""

from perception_framework.integration.wire import MessageContext, model_deployment_record_message
from perception_framework.providers.adapters import ModelDeploymentProvider
from perception_framework.providers.fakes import InMemoryModelDeploymentProvider
from perception_framework.runtime.model_deployment import (
