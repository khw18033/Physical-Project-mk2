"""implements: AI-C-06, AI-C-08, AI-C-10, AI-C-14, AI-O-04
"""
...
from perception_framework.simulation.backend import (
...
def test_s6_ai_side_only_consumes_the_single_integrated_boolean():
    ...
    from perception_framework.observability.availability import RemoteFeatureGate
...
def test_s7_four_data_kinds_produced_together_take_four_different_paths(wired_robot):
    ...
    # AI-C-07: read the bytes back through the same policy-selected format.
    serializer = SerializationPolicy.default().serializer_for("terminal_to_edge")
    payload = serializer.decode(task_transport.published[0][1])
