"""implements: AI-C-16, AI-C-09, AI-B-09
...
from perception_framework.runtime.airgap import (
    AirgapPolicy,
    AirgapViolation,
    AssetRef,
    AssetResolver,
...
def test_the_framework_itself_declares_no_mandatory_public_dependency():
    ...
    verdict = policy.evaluate(
        ...
        [
            ...
            ExternalDependency("/var/lib/perception-framework/assets", optional=False),
        ],
    )
