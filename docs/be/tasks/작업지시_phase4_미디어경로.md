...
> |---|---|---|
> | tailnet에 `pi4`·`pi6` | **둘 다 실재한다**(`100.81.196.55`·`100.76.251.100`) | ⚠ **v1이 맞았다.** 2026-09-18 검토에서 *"전 출처 0건이므로 지어낸 값"*으로 판정했으나 **그 판정이 틀렸다** — 저장소 문서에 근거가 없었을 뿐 실물에는 있었다. 다만 v1 목록도 불완전했다(아래) |
