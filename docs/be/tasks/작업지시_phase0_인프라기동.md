...
> ⚠️ **이 문서는 완료된 지시서다(2026-09-04 완료). 살아 있는 제약이 아니다.**
> 아래 제약·완료 판정은 **착수 시점의 결정**을 그대로 담고 있으며, 이후 바뀐 것이 있다.
> - **RBAC는 그 뒤 채택으로 확정됐다**(BE-Q-04, 구현은 Phase 6). 아래 "RBAC를 넣지 않는다"는
>   Phase 0 당시의 범위 울타리다.
...
> — 이 지시서의 완료 판정 항목은 `reports/2026-09-04_1620_phase0_인프라기동.md`의 검증 결과와
> 번호로 짝을 이룬다.
