...
export function ActionModal({ task, device, failure, onClose }: { task: Task; device?: Hardware; failure?: boolean; onClose(): void }) {
  ...
  const action = (kind: string) => recordHuman(kind, task.id, { speed, clearance });
