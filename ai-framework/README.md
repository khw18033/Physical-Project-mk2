...
CLAUDE.md 요구사항(AI-N/E/D/S/R/B/O/C, 51개, 담당: 진나영)을 구현하는 온디바이스·엣지 AI
...
하드웨어·백엔드·가시화 파트의 연결 계약과 병합 절차는
[docs/integration/README.md](../docs/integration/README.md) 참고.
...
참고 (51개 중 50개 완료, 1개 부분). 실 인프라 승격·하드웨어 mock 계획은
