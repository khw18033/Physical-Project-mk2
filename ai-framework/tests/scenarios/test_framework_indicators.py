"""프레임워크 특성 지표 산출 (문서 §18).

정확도(mAP 등)가 아니라 **확장성·장애격리·복구·자원적응·전송정합·도메인 범용성**을
수치로 남긴다. 실행하면 `reports/framework-indicators.json` 이 갱신되므로 발표
자료에서 그대로 인용할 수 있다.

tests for: AI-B-06, AI-B-09, AI-C-05, AI-C-11, AI-C-13, AI-C-14, AI-C-15
"""
...
REPORT_PATH = Path(__file__).resolve().parents[3] / "reports" / "framework-indicators.json"
