"""Scenario 10 — 최초 전체 구성 → 변경분(delta)만 갱신 → 잘못된 버전 롤백
Scenario 11 — 새 가상 카메라 연결 시 자동 캘리브레이션, 실패해도 영상좌표 인지 유지

tests for: AI-N-02, AI-B-05, AI-B-07, AI-E-02, AI-E-03, AI-C-02
"""

import numpy as np
import pytest

from ai_framework.common.coordinates import CoordinateFrame, SpatialValue, to_camera_local
...
from ai_framework.simulation.sources import VideoFileMediaSource, write_synthetic_video
