...
from ai_framework.contracts.profile_loader import (
...
def test_active_capability_set_differs_per_domain_without_code_change():
    ...
    assert is_capability_active(robot, "decision.subtask_generate")
    assert not is_capability_active(river, "decision.subtask_generate")
