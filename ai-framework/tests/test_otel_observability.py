"""tests for: AI-O-01, AI-O-02, AI-C-12
...
from ai_framework.providers.adapters import ObservabilityProvider
from ai_framework.providers.otel import OtelConfig, OtlpObservabilityProvider
